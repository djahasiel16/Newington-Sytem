    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='negros_requests.negrosrequestheader')),
            ],
        ),
        migrations.CreateModel(
            name='NegrosRequestItems',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='negros_requests.negrosrequestitems')),
            ],
        ),
    ]
