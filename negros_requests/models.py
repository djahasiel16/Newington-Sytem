...
class NegrosRequestHeader(models.Model):
...
class NegrosRequestItems(models.Model):
    header = models.ForeignKey(NegrosRequestHeader, on_delete=models.CASCADE)
...
class AuthorizedPersons(models.Model):
    header = models.ForeignKey(NegrosRequestHeader, on_delete=models.CASCADE)
    personnel = models.ForeignKey(Personnel, on_delete=models.CASCADE, related_name="AuthorizedPersonsNegros", null=True)
...
class Monitoring(models.Model):
    header = models.ForeignKey(NegrosRequestItems, on_delete=models.CASCADE, null=True, blank=True)
...
@receiver(post_save, sender=NegrosRequestItems)
