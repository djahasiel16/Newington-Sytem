    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_needed', models.DateField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=9)),
                ('unit', models.CharField(blank=True, max_length=20)),
                ('unit_cost', models.IntegerField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='davao_requests.davaorequestitems')),
            ],
        ),
    ]
