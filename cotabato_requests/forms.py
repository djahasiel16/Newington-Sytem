...
from .models import CotabatoRequestHeader, CotabatoRequestItems, AuthorizedPersons, Monitoring, Persons
...
class CotabatoRequestItemsForm(forms.ModelForm):
    class Meta:
        model = CotabatoRequestItems
        fields = [
            'header',
            'item_id',
            'ignore',
...
class CotabatoRequestAddItemsForm(forms.ModelForm):
    class Meta:
        model = CotabatoRequestItems
        fields = [
            'header',
