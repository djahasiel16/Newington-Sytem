    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='surigao_requests.surigaorequestheader')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='surigao_requests.surigaorequestitems')),
            ],
        ),
    ]
