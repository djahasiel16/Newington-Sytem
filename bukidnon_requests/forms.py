...
from .models import BukidnonRequestHeader, BukidnonRequestItems, AuthorizedPersons, Monitoring, Persons

class BukidnonRequestHeaderForm(forms.ModelForm):
    class Meta:
        model = BukidnonRequestHeader
        fields = [
            'rs_number',
            'payee',
            'particulars',
...
class BukidnonRequestItemsForm(forms.ModelForm):
    class Meta:
        model = BukidnonRequestItems
        fields = [
            'header',
            'item_id',
            'ignore',
...
class BukidnonRequestAddItemsForm(forms.ModelForm):
    class Meta:
        model = BukidnonRequestItems
        fields = [
            'header',
