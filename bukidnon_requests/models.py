...
class BukidnonRequestHeader(models.Model):
...
class BukidnonRequestItems(models.Model):
    header = models.ForeignKey(BukidnonRequestHeader, on_delete=models.CASCADE)
...
class AuthorizedPersons(models.Model):
    header = models.ForeignKey(BukidnonRequestHeader, on_delete=models.CASCADE)
    personnel = models.ForeignKey(Personnel, on_delete=models.CASCADE, related_name="AuthorizedPersonsBukidnon", null=True)
...
class Monitoring(models.Model):
    header = models.ForeignKey(BukidnonRequestItems, on_delete=models.CASCADE, null=True, blank=True)
...
@receiver(post_save, sender=BukidnonRequestItems)
